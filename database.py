...
def fill_publications(conn: Connection, to_csv=False):
    ...
    articles = pd.read_csv('csv/article.csv', usecols=['key', 'title', 'journal', 'pages', 'year', 'publtype', 'author'],
    ...
    proceedings = pd.read_csv('csv/proceedings.csv', usecols=['key', 'title', 'booktitle', 'year', 'publtype', 'editor'],
                              dtype={'year': int, 'publtype': str})
    books = pd.read_csv('csv/book.csv', usecols=['key', 'title', 'year', 'publtype', 'author'], dtype={'year': int,
                                                                                             'publtype': str})
    incollections = pd.read_csv('csv/incollection.csv', usecols=['key', 'title', 'pages', 'year', 'publtype', 'author'],
                                dtype={'year': int, 'publtype': str, 'pages': str})
    phdtheses = pd.read_csv('csv/phdthesis.csv', usecols=['key', 'title', 'pages', 'year', 'publtype', 'author'],
    ...
    mastertheses = pd.read_csv('csv/mastersthesis.csv', usecols=['key', 'title', 'year', 'author'], dtype={'year': int})
    ...
    proceedings.rename(inplace=True, columns={'key': 'PublicationID', 'title': 'Title', 'booktitle': 'Venue',
                                              'year': 'Year', 'publtype': 'PublicationType', 'editor': 'author'})
...
def fill_publication_author_relationships(publications: pd.DataFrame, conn: Connection, to_csv=False):
    ...
    PublicationAuthor[PublicationAuthor.duplicated(subset=['PublicationID', 'DBLPName'], keep=False)] \
